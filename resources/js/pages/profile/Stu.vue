...
const saveProfileFromModal = () => {
  // dummy save (later API)
  profile.basic = editProfile.value.basic
  showEditModal.value = false
}
...
>
  <div
    class="bg-white w-full  min-h-[60vh] max-h-[90vh] overflow-y-scroll max-w-xl rounded-2xl shadow-2xl
           overflow-hidden"
  >
 ...
 bg-gray-50 p-6 space-y-6">
    ...
    <div class="grid grid-cols-2 gap-5">
      ...
      <div class="col-span-2">
        ...
        <input
          v-model="editProfile.basic.name"
          type="text"
          placeholder="Enter full name"
          class="w-full rounded-lg bg-white border border-gray-300
      ...
      <div>
        ...
        <input
          v-model="editProfile.basic.email"
          type="email"
      ...
      <div>
        ...
        <input
          v-model="editProfile.basic.phone"
          type="text"
      ...
      <div>
        ...
        <select
          v-model="editProfile.basic.gender"
          class="w-full rounded-lg bg-white border border-gray-300
                 px-3 py-2 text-sm
                 hover:border-gray-400
                 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500"
      ...
      <div>
        ...
        <input
          v-model="editProfile.basic.blood"
          type="text"
          placeholder="e.g. B+"
          class="w-full rounded-lg bg-white border border-gray-300
                 px-3 py-2 text-sm
