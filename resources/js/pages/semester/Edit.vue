...
const form = useForm({
    course_id: props.semester.course_id,
            ...
            <div class="max-w-3xl w-full mx-auto bg-white p-6 rounded-xl shadow-md">
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div>
                        ...
                        <p v-if="form.errors.course_id" class="text-sm text-red-500 mt-1">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        />
                        <p v-if="form.errors.number" class="text-sm text-red-500 mt-1">
                            {{ form.errors.number }}
                        </p>
                    </div>
